...
type APIResponse struct {
	...
	// Примеры значений:
	//   - Invoice (один счет)
	//   - []*entities.Invoice (список счетов)
	//   - []*entities.InvoiceDetail (список деталей)
	//   - []*dictionaries.BankAccount (список счетов)
...
type BankAccountListResponse struct {
	...
	BankAccounts []*dictionaries.BankAccount `json:"bankAccounts"`
}
...
type CatalogListResponse struct {
	...
	Catalogs []*dictionaries.Catalog `json:"catalogs"`
}
