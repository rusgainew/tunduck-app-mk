...
type CreateInvoiceRequest struct {
	...
	Details []*entities.InvoiceDetail `json:"details"`
}
...
type CreateBankAccountRequest struct {
	...
	Bank *dictionaries.Bank `json:"bank"`
...
type CreateCatalogRequest struct {
	...
	CatalogType *dictionaries.ReferenceItem `json:"catalogType"`
}
