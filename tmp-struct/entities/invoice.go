...
type Invoice struct {
	...
	Status *dictionaries.ReferenceItem `json:"status"`
	...
	ReceiptType *dictionaries.ReferenceItem `json:"receiptType"`
	...
	VATDelivery *dictionaries.ReferenceItem `json:"vatDelivery"`
	...
	Country *dictionaries.Country `json:"country"`
}
